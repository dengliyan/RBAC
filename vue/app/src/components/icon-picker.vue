<template>
  ...
  <el-button slot="reference" circle :icon="currentValue&&currentValue.length>0?currentValue:'fa fa-bars'" :style="'font-size:'+size+'px'" @click="show"></el-button>   
         <el-dialog
            top="0px"
            width="100%"
            title="选择图标"
            ...
            append-to-body>
                        <div id="icon-list" style="position: absolute;left: 20px;top: 0;bottom: 0;right: 20px;overflow: auto;">
                                <i v-for="x in icons" @click="picker(x)" :key="x" :title="x" :class="'fa '+x"></i>
                        </div>
        </el-dialog>
